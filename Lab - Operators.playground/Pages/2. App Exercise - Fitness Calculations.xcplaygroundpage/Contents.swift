...
let averageHRD = (heartRate1D + heartRate2D + heartRate3D)/3.0
print(averageHRD)
// No this does not differ from the last average, because the sum is divisible by 3 so there is no remainder.
